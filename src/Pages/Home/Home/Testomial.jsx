                      ...
                      <div className="flex flex-col md:flex-row items-center justify-center mx-10">
                        ...
                        <div className="flex flex-col w-full md:w-2/3 mx-10">
                          <div className="text-stone-600 font-normal m-2 italic">
                            "The survey and polling platform we use has been an
                            integral part of our decision-making process. Its
                            robust features and ease of use have made collecting
                            and analyzing data effortless."
                          </div>
                          <div className="font-bold text-2xl text-blue-500">
                            Emily Adams
                          </div>
                          <div className="text-stone-500 text-sm">
                            <a href="#">Marketing Director, XYZ Corporation</a>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex flex-col md:flex-row items-center justify-center mx-10">
                        ...
                        <div className="flex flex-col w-full md:w-2/3 mx-10">
                          <div className="text-stone-600 font-normal m-2 italic">
                            ...
                            instrumental in gathering valuable insights from our
                            audience. Its user-friendly interface and
                ...
                <div className="overflow-hidden md:w-3/4 m-4 flex justify-center bg-white">
                  <div className="flex flex-col md:flex-row items-center justify-center md:w-3/4">
                    <div className="flex-col items-center justify-center flex py-2">
                      ...
                      <div className="text-md text-stone-700 font-medium text-center md:-ml-24 m-2">
                        See What People are Saying about our Surveys and Polling
                        Tool
                      </div>
                      <div className="flex flex-col md:flex-row items-center justify-center mx-10">
                        <div className="pl-2 pt-2 bg-gradient-to-r from-blue-700 via-blue-600 to-stone-700 rounded-full">
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center md:w-3/4">
                    <div className="flex-col items-center justify-center flex py-2">
                      ...
                      <div className="flex flex-col md:flex-row items-center justify-center mx-10">
                        ...
                        <div className="flex flex-col w-full md:w-2/3 mx-10">
                          <div className="text-stone-600 font-normal m-2 italic">
                            "This survey and polling tool has revolutionized the
                            way we gather feedback and insights from our
                      ...
                      <div className="flex flex-col md:flex-row items-center justify-center mx-10">
                        ...
                        <div className="flex flex-col w-full md:w-2/3 mx-10">
                          <div className="text-stone-600 font-normal m-2 italic">
                            ...
                            improved our data collection process. The simplicity
                            of creating surveys coupled with in-depth analysis
                            tools has made a notable impact on our
                            decision-making."
                          </div>
                          <div className="font-bold text-2xl text-blue-500">
                            Jane Smith
