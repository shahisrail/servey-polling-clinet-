...
//   const [SurveysDetails] = UseSerbayDetails()

//   return (
//     <div>
//       <div className=" ">
//         <h2>length:{SurveysDetails.length}</h2>
//       </div>
//       <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto gap-5">
//         {SurveysDetails.map((item) => (
//           <div
//             key={item._id}
//             className="max-w-sm p-6 z-10 bg-slate-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
//           >
