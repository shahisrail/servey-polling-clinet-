  ...
  return (
    <div>
      <section
        style={{
          backgroundImage:
            "url(https://i.ibb.co/2ZqT0Pb/360-F-460710131-Yk-D6-Nsivdy-Ys-Hup-Nv-O3-Y8-MPEwx-TAh-ORh.jpg)",
        }}
        ...
        <div className="container flex flex-col items-center justify-center min-h-screen px-6 mx-auto ">
          <form onSubmit={handellogin} className="w-full max-w-md">
            ...
            <div className="mt-6">
              ...
              <p className="mt-4 text-center text-white dark:text-gray-400">
                or sign in with
              </p>
            </div>
          </form>
          <div className="w-full max-w-md">
            ...
            >
              ...
              <span className="mx-2 text-white hover:text-black">Sign in with Google</span>
            </button>
            <div className="mt-6 text-center ">
              <p className="text-sm text-white  hover:underline font-bold">
